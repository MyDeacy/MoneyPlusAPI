...
/*所持金増やす*/	
	public function addMoney(String $name, int $price, $case){
		...
		if($this->money->exists($name)){
			...
			$this->m->getServer()->getPluginManager()->callEvent($event = new MoneyChangeEvent($this, $this->m, $name, $hand, $result, $case));
...
/*初回入室時などの際に登録*/
	public function setPlayerData(String $name, $case){
		...
		$this->m->getServer()->getPluginManager()->callEvent($event = new UserRegisterEvent($this, $this->m, $name, $defmoney, $case));
